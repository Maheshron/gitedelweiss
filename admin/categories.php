          ...
          <li>
            <div class="panel">
              <figure class="overlay overlay-hover animation-hover">
                 <div  title="Journal Title" style="height:60px;font-size:15px"><b>Medical Science</b></div>
                <figcaption class="overlay-panel overlay-background overlay-fade text-center vertical-align animation-hover">
                  ...
                  <a href="sub_categories.php?categories=medical" class="btn btn-outline btn-default project-button" title="View Journal"><i class="icon wb-eye" aria-hidden="true" ></i> Go</a>
                </figcaption>
              </figure>
