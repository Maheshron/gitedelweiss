          ...
          <div class="row row-lg">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Journal Categorie</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="categorie" required autocomplete="false">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">Journal Sub Categorie</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="sub_categorie" required autocomplete="false">
                </div>
                <div class="form-group col-md-6">
    ...
    if(isset($_REQUEST['add_journal'])){
      ...
      $temp_j_journal_image = $_FILES['journal_image']['tmp_name'];
       ...
       $j_journal_image_extension = pathinfo($j_journal_image, PATHINFO_EXTENSION);
        ...
        $result = $user->add_journal($journal_title,$j_journal_logo,$j_journal_image,$journal_s_name,$journal_issn_no,$journal_email,$journal_url,$youtube_link,$journal_short_desc,$home_page,$aims_scope_page,$meta_keywords,$meta_title,$meta_desc,$username,$pass,$logoalt,$imagealt,$categorie,$sub_categorie);
        if($result){
