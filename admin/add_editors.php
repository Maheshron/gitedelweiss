        ...
        <div class="panel-body container-fluid">
          <div class="row row-lg">
            ...
            <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" id="inputBasicFirstName" name="palttext" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
                        <label class="form-control-label" for="inputBasicFirstName">University Image Alternative Text</label>
                        <input type="text" class="form-control" id="inputBasicFirstName" name="ualttext" autocomplete="off">
                </div>
                <div class="form-group col-md-6">
