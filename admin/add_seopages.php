        ...
        <div class="panel-body container-fluid">
            ...
            <div class="row">
                ...
                <div class="form-group col-md-12">
                       ...
                       <textarea id="summernote" data-plugin="summernote"   name="description" required></textarea>
                </div>
               <div class="form-group col-md-12">
                        <label class="form-control-label" for="inputBasicFirstName">Keywords</label>
                    
                       <textarea id="summernote" data-plugin="summernote"   name="keywords" required></textarea>
