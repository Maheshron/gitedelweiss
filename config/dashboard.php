...
include "config.php";
    ...
    /*** for indexing count ***/
      ...
      public function get_journallist1(){
        ...
        /*** Add_Indexing ***/
        public function add_indexing($indexlogo_title,$indexing_image,$indexlogo_link,$indexlogo_description,$indexalttext){
          
          
            $sql20 = "insert into indexing(index_title,index_logo,logo_description,link,added_by,added_on,alttext) values('$indexlogo_title','$indexing_image','$indexlogo_description','$indexlogo_link',1,NOW(),'$indexalttext')";
        ...
        /*** Add_Journals ***/
        public function add_journal($journal_title,$j_journal_logo,$j_journal_image,$journal_s_name,$journal_issn_no,$journal_email,$journal_url,$youtube_link,$journal_short_desc,$home_page,$aims_scope_page,$meta_keywords,$meta_title,$meta_desc,$username,$pass,$logoalt,$imagealt,$categorie,$sub_categorie){
          $sqladd_journal ="insert into journal(journal_title,journal_header_img,journal_img,journal_short_name,issn_number,journal_emailid,journal_url,journal_youtube_url,journal_short_description,journal_home_page,journal_aim_scope,journal_meta_title,journal_meta_key,journal_meta_desc,added_by,logoalt,imagealt,categorie,sub_categorie) values ('$journal_title','$j_journal_logo','$j_journal_image','$journal_s_name','$journal_issn_no','$journal_email','$journal_url','$youtube_link','$journal_short_desc','$home_page','$aims_scope_page','$meta_title','$meta_keywords','$meta_desc',1,'$logoalt','$imagealt','$categorie','$sub_categorie')";
      ...
      public function add_journal_article($journal_id,$r,$volume_number,$issue_number,$status,$month,$year,$article_title,$article_short_name,$article_type,$doi_number,$doi_link,$university_name,$country,$author_name,$pdf_link,$full_text_link,$full_text,$aabstract,$abstract_link,$supplimentary_link,$enter_keywords,$starting_page_number,$ending_page_number,$enter_issn,$insertValue,$imagealttext){
                                $articalinpress=1;
                                $sql45 = "insert into articals(journal_id,artical_name,artical_short_name,artical_type_id,artical_number,doi_number,doi_link,author_names,university_name,country_name,pdf_link,full_text_link,artical_content,abstract,abstract_link,supplimentry_link,keywords,starting_page_number,ending_page_number,issn_number,volume_number,issue_number,added_by,added_on,year,month,status,pdf,status_type,image,imagealttext) values('$journal_id','$article_title','$article_short_name','$article_type','$issue_number','$doi_number','$doi_link','$author_name','$university_name','$country','$pdf_link','$full_text_link','$full_text','$aabstract','$abstract_link','$supplimentary_link','$enter_keywords','$starting_page_number','$ending_page_number','$enter_issn','$volume_number','$issue_number',1,NOW(),'$year','$month','$status','$r','$articalinpress','$insertValue','$imagealttext')";
      ...
      public function get_journal_articles_byid($id){
        ...
        public function currentIssue($id){
          $sqlci = "select * from articals where journal_id='$id' and status_type = 'currentIssue'";
