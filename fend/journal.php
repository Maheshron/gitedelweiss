                ...
                <div class="container">
                    ...
                    <div class="menu" id="open-navbar1">
                        <ul class="list">
                            ...
                            <li><a href="editor-in-chief.php?journal_id=<?php echo $id; ?>">Editorial Panel</a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="single-support-area">
                                    ...
                                    <div class="support-content">
                                        <ul>
                                            <li><a href="article-in-press.php?journal_id=<?php echo $id; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i> Articles in press</a></li>
                                            <li><a href="current-issue.php?journal_id=<?php echo $id; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i> Current issues</a></li>
                                            <li><a href="previous-issue.php?journal_id=<?php echo $id; ?>"><i class="fa fa-angle-right" aria-hidden="true"></i> previous issues</a></li>
                                            <li><a href="#"><i class="fa fa-angle-right" aria-hidden="true"></i> All issues</a></li>
                                ...
                                <div class="single-support-area">
                                    ...
                                    <div class="support-content">
                                        ...
                                        <ul>
                                            ...
                                            <li><a class="view-more" href="#">View more <i class="icofont-long-arrow-right"></i></a></li>
                                        </ul>
                            ...
                            <div class="container container-1370">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="row">
                                            <?php 
                                            $sql3 = "select * from articals where journal_id='$id' and status_type ='ArticleInPress' limit 0,2 ";
                                            $result3 = mysqli_query($con,$sql3);
                                            while( $row3 = mysqli_fetch_array($result3)){ ?>
                                            <div class="col-lg-6  nopadding">
                                                <div class="press-article">
                                                    <a href="article.php?artical_id=<?php echo $row3['artical_id']; ?>"><?php echo $row3['artical_name']; ?></a>
                                                </div>
                                                <div class="auther-name">
                                                    <p><?php echo $row3['author_names']; ?></p>
                                                </div>
                                        <div class="download-pdf"><a href="download.php?artical_id=<?php echo $row3['pdf'] ?>"><img src="assets/images/PDF_32.png"><?php echo $row3['artical_short_name']; ?></a></div>
                                            </div>
                                            <?php } ?>
                                            <!-- <div class="col-lg-6 nopadding">
                                                <div class="press-article ">
                                        ...
                                        <div class="row">
                                        <?php 
                                            $sql4 = "select * from articals where journal_id='$id' and status_type ='ArticleInPress' limit 2,4 ";
                                            $result4 = mysqli_query($con,$sql4);
                                            while( $row4 = mysqli_fetch_array($result4)){ ?>
                                            <div class="col-lg-6 nopadding">
                                                <div class="press-article">
                                                    <a href="article.php"><?php echo $row4['artical_name'];?></a>
                                                </div>
                                                <div class="auther-name">
                                                    <p><?php echo $row4['author_names']; ?></p>
                                                </div>
                                        <div class="download-pdf"><a href="download.php?artical_id=<?php echo $row4['artical_id']; ?>"><img src="assets/images/PDF_32.png"><?php echo $row4['artical_short_name']; ?></a></div>
                                            </div>
                                            <?php } ?>
                                            <!-- <div class="col-lg-6 nopadding">
                                                <div class="press-article">
                                    ...
                                    <div class="container container-1370">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <?php  
                                                    $sql7 = "select * from articals where journal_id='$id' limit 0,4" ;
                                                    $result7 = mysqli_query($con,$sql7);
                                                    while($row7 = mysqli_fetch_array($result7)){ ?>
                                                    <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                            <a href="article.php?artical_id=<?php echo $row7['artical_id']; ?>"><?php echo $row7['artical_name']; ?></a>
                                                        </div>
                                                        <div class="auther-name">
                                                ...
                                                <div class="row">
                                                <?php  
                                                    $sql8 = "select * from articals where journal_id='$id' limit 4,8" ;
                                                    $result8 = mysqli_query($con,$sql8);
                                                    while($row8 = mysqli_fetch_array($result8)){ ?>
                                                    <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                            <a href="article.php?artical_id=<?php echo $row8['artical_id']; ?>"><?php echo $row8['artical_name']; ?></a>
                                                        </div>
                                                        <div class="auther-name">
                                    ...
                                    <div class="container container-1370">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                <?php  
                                                    $sql9 = "select * from articals where journal_id='$id' limit 0,4" ;
                                                    $result9 = mysqli_query($con,$sql9);
                                                    while($row9 = mysqli_fetch_array($result9)){ ?>
                                                    <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                            <a href="article.php?artical_id=<?php echo $row9['artical_id']; ?>"><?php echo $row9['artical_name']; ?></a>
                                                        </div>
                                                        <div class="auther-name">
                                                            <p><?php echo $row9['author_names']; ?></p>
                                                        </div>
                                                <div class="download-pdf"><a href="download.php?artical_id=<?php $row9['artical_id']; ?>"><img src="assets/images/PDF_32.png"><?php echo $row9['artical_short_name']; ?></a></div>
                                                    </div>
                                                    <?php } ?>
                                                    <!-- <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                ...
                                                <div class="row">
                                                <?php  
                                                    $sql10 = "select * from articals where journal_id='$id' limit 4,8" ;
                                                    $result10 = mysqli_query($con,$sql10);
                                                    while($row10 = mysqli_fetch_array($result10)){ ?>
                                                    <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                            <a href="article.php?artical_id=<?php echo $row10['artical_id']; ?>"><?php echo $row10['artical_name']; ?></a>
                                                        </div>
                                                        <div class="auther-name">
                                                            <p><?php echo $row10['author_names']; ?></p>
                                                        </div>
                                                <div class="download-pdf"><a href="download.php?artical_id=<?php echo $row10['artical_id']; ?>"><img src="assets/images/PDF_32.png"><?php echo $row10['artical_short_name']; ?></a></div>
                                                    </div>
                                                    <?php } ?>
                                                    <!-- <div class="col-lg-3 nopadding">
                                                        <div class="press-article">
                                    ...
                                    <div class="container container-1370">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                <?php  
                                                    $sql11 = "select * from articals where journal_id='$id' limit 0,4" ;
                                                    $result11 = mysqli_query($con,$sql11);
                                                    while($row11 = mysqli_fetch_array($result11)){ ?>
                                                    <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                            <a href="article.php?artical_id=<?php echo $row11['artical_id']; ?>"><?php echo $row11['artical_name']; ?></a>
                                                        </div>
                                                        <div class="auther-name">
                                                            <p><?php echo $row11['author_names']; ?></p>
                                                        </div>
                                                <div class="download-pdf"><a href="download.php?artical_id=<?php echo $row11['artical_id']; ?>"><img src="assets/images/PDF_32.png"><?php echo $row11['artical_short_name']; ?></a></div>
                                                    </div>
                                                    <?php } ?>
                                                    <!-- <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                ...
                                                <div class="row">
                                                <?php  
                                                    $sql12 = "select * from articals where journal_id='$id' limit 4,8" ;
                                                    $result12 = mysqli_query($con,$sql12);
                                                    while($row12 = mysqli_fetch_array($result12)){ ?>
                                                    <div class="col-lg-3  nopadding">
                                                        <div class="press-article">
                                                            <a href="article.php?artical_id=<?php echo $row12['artical_id']; ?>"><?php echo $row12['artical_name']; ?></a>
                                                        </div>
                                                        <div class="auther-name">
                                                            <p><?php echo $row12['author_names']; ?></p>
                                                        </div>
                                                <div class="download-pdf"><a href="download.php?artical_id=<?php echo $row12['artical_id']; ?>"><img src="assets/images/PDF_32.png"><?php echo $row12['artical_short_name']; ?></a></div>
                                                    </div>
                                                    <?php } ?>
