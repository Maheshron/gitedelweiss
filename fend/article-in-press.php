...
include "connect.php";
$id = $_GET['journal_id'];
$sql = "select * from articals where journal_id='$id' and status_type='ArticleInPress' limit 0,6";
                        ...
                        <div class="issue-section" style="box-shadow: 0 5px 25px rgba(0, 0, 0, 0.1);; padding: 20px">
                            <div class="row">
                                ...
                                <div class=" col-lg-6 left-side">
                                    ...
                                    <div class="Links-box">
                                        <a  href="article.php?artical_id=<?php echo $row['artical_id']; ?>" class="btn btn-primary">Full Text</a>
                                        <a class="pdf-btn" href="download.php?artical_id=<?php echo $row['artical_id']; ?>" ><img src="assets/images/PDF_32.png"><?php  echo $row['artical_short_name']; ?></a>
                                    </div>
                                </div>
                                <div class="col-lg-6 right-side">
                                    ...
                                    <?php echo $row['abstract']; ?>
                                     ...
                                     <a style="float: right" class="view-more" href="article.php?artical_id=<?php echo $row['artical_id']; ?>" >View more <i class="icofont-long-arrow-right"></i></a>
                                </div>
