    ...
    <div class="container">
      ...
      <div class="menu" id="open-navbar1">
        <ul class="list">
          ...
          <li><a href="article-in-press.php?artical_id=<?php echo $id; ?>">Articles in Press</a></li>
          <li><a href="currrnt-issue.php">Current Issue</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="recomand-article">
                            <a href="article.php?artical_id=<?php echo $row['artical_id']; ?>"> <?php echo $row['artical_name']; ?> </a>
